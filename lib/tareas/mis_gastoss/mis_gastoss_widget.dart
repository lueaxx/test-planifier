...
import 'mis_gastoss_model.dart';
export 'mis_gastoss_model.dart';

class MisGastossWidget extends StatefulWidget {
  const MisGastossWidget({
    super.key,
    this.tipoCuenta,
  });
  ...
  static String routeName = 'misGastoss';
  static String routePath = '/misGastos';

  @override
  State<MisGastossWidget> createState() => _MisGastossWidgetState();
}

class _MisGastossWidgetState extends State<MisGastossWidget> {
  late MisGastossModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MisGastossModel());
